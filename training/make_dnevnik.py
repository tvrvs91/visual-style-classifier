...
- Тема ВКР: Автоматическая классификация фотографий по визуальному стилю
...
THESIS_TOPIC = ("Автоматическая классификация фотографий по визуальному "
                "стилю на основе transfer learning")
...
def build():
    ...
    add_para(doc,
             ...
             "PostgreSQL, MinIO, RabbitMQ); проведено шесть углублённых "
             "исследовательских экспериментов с критическим анализом "
             "полученных результатов. В ходе работы студент обнаружил "
             "и самостоятельно устранил методологическую проблему "
             "data leakage в первоначальном эксперименте, что "
             "свидетельствует о высоком уровне методологической "
             "зрелости.",
