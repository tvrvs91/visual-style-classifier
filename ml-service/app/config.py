...
class Settings(BaseSettings):
    ...
    # Итоговая таксономия (v3, 8 классов):
    # - street удалён ранее как жанр/сюжет (не визуальный стиль)
    # - moody удалён в v3 — методологически слабый (эмоциональный, не визуальный)
    # - monochrome добавлен — операционально определён через saturation ≈ 0
    # - neon добавлен — высокая насыщенность + тёмный фон (F1=0.93 в v3)
    styles: list[str] = [
        "airy",
        "dark",
        "dramatic",
