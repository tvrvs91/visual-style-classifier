...
class Settings(BaseSettings):
    ...
    # Изначально было 8 классов; street исключён как жанр/сюжет (не визуальный стиль).
    # moody оставлен с сокращённой до 500 выборкой — метрики ниже среднего
    # (F1 ≈ 0.55), но без него модель имела бы только 6 классов.
    styles: list[str] = [
        "airy",
        "dark",
        "dramatic",
